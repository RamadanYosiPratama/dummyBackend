<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="mb-10">
                <a href="{{ route('covid.create') }}" class="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded">
                    + Create Covid Item Product
                </a>
            </div>
            <div class="bg-white">
                        ...
                        @forelse($covid as $item)
                            <tr>
                                ...
                                <td class="border px-6 py- text-center">
                                    <a href="{{ route('covid.edit', $item->id) }}" class="inline-block bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 mx-2 rounded">
                                        Edit
                                    </a>
                                    <form action="{{ route('covid.destroy', $item->id) }}" method="POST" class="inline-block">
