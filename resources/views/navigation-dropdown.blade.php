    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-jet-nav-link href="/dashboard/covid" :active="request()->routeIs('dashboard/covid')">
                        {{ __('covid') }}
                    </x-jet-nav-link>
                </div>
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-jet-nav-link href="/dashboard/khitan" :active="request()->routeIs('dashboard/khitan')">
                        {{ __('covid') }}
                    </x-jet-nav-link>
                </div>
            </div>
